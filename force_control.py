...
ADMITTANCE_K_XY = 5.0           # X, Y 방향 강성 [N/mm]
ADMITTANCE_K_Z  = 8.0           # Z 방향 강성 [N/mm] (수직 방향 더 단단하게)

# 출력 위치 변위 클리핑 [mm] - 1 제어 주기 최대 이동량
MAX_DISP_MM = 10.0                # 안전을 위한 최대 변위
...
def main():
    ...
    # ------------------------------------------------------------------
    input('\n[준비] 로봇과 센서를 정지 상태로 두고 Enter를 누르면 0점 보정을 시작합니다... ')
