...
VIRTUAL_POINT_FORCE_GAIN_Z     = 8.0   # mm / (N*s)
...
# ---------------------------------------------------------------------------
STIFFNESS_XY  = 8.0   # N/mm
STIFFNESS_Z   = 8.0   # N/mm
DAMPING_XY    = 0.20  # N*s/mm   => K/D = ~13/s  [v3: 0.20→0.30, 추격 속도 완만하게]
...
# ---------------------------------------------------------------------------
MAX_VIRTUAL_STEP_MM  = 50.0
MAX_VIRTUAL_STEP_DEG = 2.0
MAX_COMMAND_STEP_MM  = 50.0   # [v3: 5.0→2.0, 특이점 근처 한 루프당 최대 이동량 제한]
